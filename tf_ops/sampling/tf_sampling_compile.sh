...
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I $TF_PATH -I $CUDA_PATH/include -I $TF_PATH/external/nsync/public -lcudart -L $CUDA_PATH/lib64/ -L $TF_PATH_LIB -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0